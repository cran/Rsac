...
/** FUNC DEF */ void CALL_GETSEIS(char **fn, int *kind, double *x, int *n, double *dt, int *DATE1, double *sec)
{
...
/** FUNC DEF */ void CALL_SETSEIS(char **fn, int *kind, int *n, double *dt, int *DATE1, double *sec, char **stn, char **cmpn)
{
